...
alter table abstract_card drop foreign key fk_abstract_card_deck_id;
drop index ix_abstract_card_deck_id on abstract_card;

alter table deck drop foreign key fk_deck_profile_email;
drop index ix_deck_profile_email on deck;
